    ...
    return (
        <div  className='about-container'>
            ...
            <div  className='about-text-container'>
                <h1>Suculenta</h1>
                <p>Somos un vivero dedicado a ofrecer plantas de alta calidad y un servicio excepcional a nuestros clientes. Contamos con una amplia variedad de plantas, desde cactus y suculentas hasta árboles frutales y plantas decorativas. También ofrecemos servicios de paisajismo y mantenimiento de jardines.</p>
